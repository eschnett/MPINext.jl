# Adapted from pympistandard/_kinds.py
...
const kinds = Dict(
    ...
    "F90_WIN" => Kind(
        name="F90_WIN", _lis=nothing, _iso_c_small="MPI_Fint", _f90_small=nothing, _f08_small=nothing
    ),
    "F90_OP" => Kind(
        name="F90_OP", _lis=nothing, _iso_c_small="MPI_Fint", _f90_small=nothing, _f08_small=nothing
    ),
    "F90_INFO" => Kind(
        name="F90_INFO",
        _lis=nothing,
